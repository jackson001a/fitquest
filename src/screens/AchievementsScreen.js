...
const s = StyleSheet.create({
  ...
  achieveTouch: { flex: 1 },
  achieveInner: { borderRadius: RADIUS.xl, borderWidth: 1, padding: 14, gap: 8, minHeight: 175, overflow: 'hidden', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.35, shadowRadius: 16 },
  achieveGlow: { ...StyleSheet.absoluteFillObject, borderRadius: RADIUS.lg },
  achieveTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 2 },
  achieveEmojiWrap: { width: 50, height: 50, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  ...
  achieveName: { color: COLORS.white, fontSize: 14, fontWeight: '900', letterSpacing: 0.5 },
  achieveDesc: { color: COLORS.gray, fontSize: 11, lineHeight: 16 },
  achieveProgressWrapper: { marginTop: 4, gap: 4 },
  achieveBarBg: { height: 3, backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: RADIUS.full, overflow: 'hidden' },
  achieveBarFill: { height: '100%', borderRadius: RADIUS.full },
  achievePct: { fontSize: 10, fontWeight: '800', alignSelf: 'flex-end' },
  achieveDate: { fontSize: 10, fontWeight: '600', marginTop: 2 },
  achieveXPRow: { borderRadius: RADIUS.md, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 5, alignSelf: 'flex-start', marginTop: 'auto' },
  achieveXP: { fontSize: 12, fontWeight: '900' },
});
