...
const styles = StyleSheet.create({
  ...
  // Group Card
  groupCard: { borderRadius: RADIUS.xl, padding: SPACING.md, borderWidth: 2, gap: 14, marginBottom: SPACING.md, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 10 },
  ...
  groupMemberRing: { borderRadius: 30, borderWidth: 2.5, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.8, shadowRadius: 8, elevation: 6 },
  groupMemberAvatar: { width: 52, height: 52, alignItems: 'center', justifyContent: 'center' },
  ...
  groupMemberDot: { width: 8, height: 8, borderRadius: 4 },
  ...
  rmcCard: { borderRadius: RADIUS.xl, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', padding: 12, gap: 8, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.5, shadowRadius: 16, elevation: 14, overflow: 'hidden' },
  ...
  rmcScore: { color: COLORS.white, fontSize: 34, fontWeight: '900', lineHeight: 38 },
  rmcUnit: { color: COLORS.grayDark, fontSize: 9, fontWeight: '600' },
  rmcLeaderBadge: { borderRadius: RADIUS.full, paddingHorizontal: 8, paddingVertical: 3, marginTop: 2, borderWidth: 1 },
  ...
  rmcFooter: { flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: RADIUS.lg, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 8 },
